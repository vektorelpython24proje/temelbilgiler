...
def print_utf8_text(image,text,fontName='DejaVuSerif.ttf',color=(0,0,0),yer=(10,10),boy=48,arkaRenk=None):
    ...
    if arkaRenk: # eğer arkaplan rengi varsa boya
        ...
        cv2.rectangle(image,(yer[0],yer[1]),(yer[0]+ll,yer[1]+boy+4),arkaRenk,-1)
    ...
    if __name__ == "__main__":
        ...
        if windows:
            ...
            imaj = print_utf8_text(imaj, "SİYAH " + fontName,fontName,renk,yer)
            ...
            yer = (100,120);boy=28
            imaj=print_utf8_text(imaj, "KIRMIZI "+fontName,renk,yer,boy)
